...
Page({
  ...
  doGetPhone: function (options) {
    ...
    wx.request({
      ...
      url: 'https://wx.sdkndsm.com/qishen/tp5/public/index.php/qisheng/Ptprograme/decryptData.html',
      method: 'POST',
      data: {
    ...
    wx.login({
      success(res) {
        if (res.code) {
          ...
          app.wxRequest('qisheng/Ptprograme/get_unionid.html', 'post', postData, _this.getSessionKey, _this.error)
        }
      },
      error(error) {
        throw error;
